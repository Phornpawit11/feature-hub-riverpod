...
#ifndef TODOS_RIVERPOD_SWIFT_H
#define TODOS_RIVERPOD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="todos_riverpod",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14todos_riverpod11AppDelegate")
...
SWIFT_CLASS("_TtC14todos_riverpod17MainFlutterWindow")
